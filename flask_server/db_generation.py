...
#if its a foregin currency, the amount displayed should be amount*exchange_rate, it might make sense to add fields to expense and get rid of foreign_currency
for i in range(3):
